    ...
    return (
      <View style={styles.container}>
        <ScrollView style={styles.container}>
  				...
  				<ProximaText style={styles.header}> 1: Poor Meal Planning </ProximaText>
  				...
  				<ProximaText style={styles.header}> 2: Too Many Meals Away From Home </ProximaText>
  				...
  				<ProximaText style={styles.header}> 3: Too Many Processed Foods</ProximaText>
  				...
  				<ProximaText style={styles.header}> 4: Too Much Added Sugar</ProximaText>
  				...
  				<ProximaText style={styles.header}> 5. Mindless Eating</ProximaText>
  				...
  				<ProximaText style={styles.header}> 6. Not Eating Together</ProximaText>
  				...
  				<ProximaText style={styles.header}> 7: Eating on the Run</ProximaText>
  				...
  				<ProximaText style={styles.header}> 8: Giant Portion Sizes</ProximaText>

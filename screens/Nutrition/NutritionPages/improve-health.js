    ...
    return (
      <ScrollView style={styles.container}>
        <Text style={styles.header}> Tips for improving your health </Text>
				...
				<Text>Do you have a health problem or risk factor, such as high blood pressure or high cholesterol?</Text>
				<Text>Did your doctor tell you that you can improve your condition with better nutrition?
				Do diabetes, cancer, heart disease, or osteoporosis run in your family?</Text>
				<Text>Are you overweight?</Text>
				<Text>Do you have questions about what foods you should eat or whether you should take vitamins?</Text>
				<Text>Do you think that you would benefit from seeing a registered dietitian or someone who specializes in nutrition counseling? </Text>
				<Text style={styles.header}> Path to improved health </Text>
				<Text> It can be hard to change your eating habits. It helps if you focus on small changes. Making changes to your diet may also be beneficial if you have diseases that can be made worse by things you are eating or drinking. Symptoms from conditions such as kidney disease, lactose intolerance, and celiac disease can all benefit from changes in diet. Below are suggestions to improve your health. Be sure to stay in touch with your doctor so they know how you are doing.</Text>
				<Text>
					...
					- Think about asking for help from a dietitian. They can help you follow a special diet, especially if you have a health issue. </Text>
				<Text> Almost everyone can benefit from cutting back on unhealthy fat. If you currently eat a lot of fat, commit to cutting back and changing your habits. Unhealthy fats include things such as: dark chicken meat; poultry skin; fatty cuts of pork, beef, and lamb; and high-fat dairy foods (whole milk, butter, cheeses). Ways to cut back on unhealthy fats include:</Text>
				<Text>
				...
				<Text style={styles.header}> Things to consider </Text>
				<Text> Balanced nutrition and regular exercise are good for your health. These habits can help you lose or maintain weight. Try to set realistic goals. They could be making some of the small diet changes listed above or walking daily.</Text>

				<Text>Doctors and dietitians suggest making healthy eating habits a part of daily life rather than following fad diets. Nutrition tips and diets from different sources can be misleading. Keep in mind the advice below, and always check with your doctor first.</Text>

				<Text>Secret diets aren’t the answer. Fad or short-term diets may promise to help you lose weight fast. However, they are hard to keep up with and could be unhealthy.
				...
				Diet programs or products can confuse you with their claims. Most people in these ads get paid for their endorsements. They don’t talk about side effects, problems, or regained weight.</Text>
				<Text style={styles.header}>Questions to ask your doctor</Text>
				<Text>
